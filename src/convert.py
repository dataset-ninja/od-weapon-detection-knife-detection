...
def convert_and_upload_supervisely_project(
    ...
    knife_images_path = os.path.join("OD-WeaponDetection-master","Knife_detection","Images")
    pistol_anns_path = os.path.join("OD-WeaponDetection-master","Knife_detection","annotations")
    ...
    knife = sly.ObjClass("knife", sly.Rectangle)


    project = api.project.create(workspace_id, project_name, change_name_if_conflict=True)
    meta = sly.ProjectMeta(obj_classes=[knife])
    api.project.update_meta(project.id, meta.to_json())

    dataset = api.dataset.create(project.id, ds_name, change_name_if_conflict=True)

    image_pathes = [os.path.join(knife_images_path, img) for img in os.listdir(knife_images_path)]
